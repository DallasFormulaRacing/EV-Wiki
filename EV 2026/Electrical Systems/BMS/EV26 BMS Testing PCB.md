...
## Block Diagram
![[BMS Testing PCB Diagram-1.png|3964x2088]]
...
- [ ] Add a enable/disable switch for each cell connection, so we can test Open-Wire, I was thinking a DIP switch like this:![[DIP switch.png|317x317]]
