...
* 4x Wheel based CANpute nodes [daq-wheel-nodes](daq-wheel-nodes.md)
* 1x ride height CANpute node [daq-ride-height](daq-ride-height.md)
* 1x Dash CANpute node [daq-dash-display](daq-dash-display.md)
* 1x Dash Display [daq-dash-display](daq-dash-display.md)
* 1x VCU [vcu-daq-integration](../vehicle-control-unit/vcu-daq-integration.md)
* 1x PDM [pdm-daq-integration](../power-delivery-module/pdm-daq-integration.md)
